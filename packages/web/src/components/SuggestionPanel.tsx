...
export const SuggestionPanel: React.FC<Props>= (props) => {
  ...
  return (
    <nav className={`top-20 z-50 transition-all fixed -right-64 bg-aws-squid-ink lg:right-0 lg:z-0 flex w-64 flex-col text-sm text-black print:hidden ${isOpenDrawer ? 'right-0' : '-right-64'}${switchDrawer}`}>
